...
(defmethod lte-distance ((unit1 meter) (unit2 kilometer))
...
(defmethod lte-distance ((unit1 kilometer) (unit2 meter))
  (<= (* 1000 (val unit1)) (val unit2)))

(defmethod lte-distance ((unit1 kilometer) (unit2 centimeter))
  (<= (* 1000 (val unit1)) (val unit2)))
